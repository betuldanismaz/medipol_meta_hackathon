...
export const Route = createFileRoute("/for-businesses")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kafe, butik veya yerel dükkan; doğru influencer'ı saniyeler içinde bul." },
    ],
  }),
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <div className="mt-8 flex gap-3">
            <Button asChild size="lg" className="bg-gradient-brand text-primary-foreground"><Link to="/auth/register">İşletme Olarak Katıl</Link></Button>
            <Button asChild size="lg" variant="outline"><Link to="/influencers">Influencer'ları Gör</Link></Button>
          </div>
        </div>
      </section>
    </SiteShell>
