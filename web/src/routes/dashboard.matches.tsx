...
export const Route = createFileRoute("/dashboard/matches")({
  head: () => ({ meta: [{ title: "Eşleşmeler — Dashboard" }] }),
  component: Matches,
});
    ...
    <div>
      ...
      <div className="grid gap-3 mt-6">
        {matches.map((m) => {
          ...
          return (
            <Link key={m.id} to="/dashboard/messages" className="rounded-2xl border border-border bg-card p-4 flex items-center gap-4 hover:shadow-[var(--shadow-glow)] transition">
